...
public class TestConfig{
	...
	public static String from = "j.neeraj2011@gmail.com";
	public static String password = "London@12";
	public static String[] to ={"engneeraj.jain@gmail.com","trainer@way2automation.com"};
